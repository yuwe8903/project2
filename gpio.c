...
void GPIO_Configure()
{
	...
	PORTD_PCR1  |= PORTB_MUX1; /*MUX 001 Alt1 for GPIO*/
	PORTD_PCR1  &= PORTB_MUX2;

	GPIOB_PDDR |= RGB_RED_PIN;   /*set GPIO port to output*/
	GPIOB_PDDR |= RGB_GREEN_PIN; /*set GPIO port to output*/
	GPIOD_PDDR |= RGB_BLUE_PIN;  /*set GPIO port to output*/
